    ...
    <>
      <div className='flex flex-row items-center justify-between h-20 px-6 fixed w-screen m-0 top-0 z-50 lg:h-16 xl:h-16'
        ...
        <div className="w-1/3 flex justify-start text-xl font-['Barlow_Condensed'] sm:hidden lg:text-sm xl:text-sm md:text-sm">
          <Link to="/movies"><span className='mx-4 bg-clip-text text-transparent bg-[#eccbafdd] cursor-pointer hover:text-[#f3b83ae8] transition'>Movies</span></Link>
          <Link to="/tv"><span className='mx-4 bg-clip-text text-transparent bg-[#eccbafdd] cursor-pointer hover:text-[#f3b83ae8] transition'>TV Shows</span></Link>
          <Link to="/upcoming"><span className='mx-4 bg-clip-text text-transparent bg-[#eccbafdd] cursor-pointer hover:text-[#f3b83ae8] transition'>Coming Soon</span></Link>
        </div>
        <div className="bg-[#1f2123] font-['Barlow_Condensed'] w-1/3 p-3 text-xl rounded-md shadow-sm flex sm:hidden lg:p-1 xl:p-1 md:p-1 relative" ref={searchRef}>
          <input
            type="text"
            placeholder='Search'
            ...
            required
          />
          <Link to={`/search/${query.toLowerCase().split(" ").join("-")}`} state={{ term:query }} onClick={() => setShowDropdown(false)}>
      ...
      <Menu
          ...
          <MenuItem onClick={handleClose} style={{fontFamily:"Barlow Condensed"}}>
            <Link to="/upcoming" className='w-full'><span className='bg-clip-text text-transparent bg-[#eccbafdd] cursor-pointer'>Coming Soon</span></Link>
          </MenuItem>
          <MenuItem style={{color:"#eccbafdd",fontFamily:"Barlow Condensed", position: 'relative'}} ref={mobileSearchRef}>
            <input
              type="text"
              placeholder='Search'
